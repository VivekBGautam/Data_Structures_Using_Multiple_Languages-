// Q - Write a program which find first occurance of given number from linked list.
...
//  Description   : Find first Occurance of given number from linked list.
//  Input         : PNODE first → Pointer to first node
//  Output        : Return first occurance
//  Author        : Vivek Bhauraj Gautam
//  Date          : 30/12/2025
//
////////////////////////////////////////////////////////////////////////////////////////////////////
int FirstOccur(PNODE first, int no)
{
    ...
    while(first != NULL)
    {
        ...
        {
            iPos = iIndex;
            break;   // we can achive without iPos 
        }
...
int main()
{
    ...
    iRet = FirstOccur(head, 231);
    printf("First Occurance of given number is  from linked list is : %d\n",iRet);
