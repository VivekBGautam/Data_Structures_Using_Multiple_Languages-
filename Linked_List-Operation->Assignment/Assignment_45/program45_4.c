...
//  Description   : Count greater element than given number from linked list.
//  Input         : PNODE first → Pointer to first node
//  Output        : Return count of greater element than X
//  Author        : Vivek Bhauraj Gautam
//  Date          : 30/12/2025
//
////////////////////////////////////////////////////////////////////////////////////////////////////
...
int main()
{
    ...
    iRet = CountGreater(head, 231);
    printf("Count of greater number than given number from linked list is : %d\n",iRet);
