// Q - Write a program which Replace Negative number with absolute value  -  02/01/2026
...
//  Description   : Replace Negative number with absolute value.
...
int main()
{
    ...
    printf("Modified linked list is is :\n");
    MakeAbsolute(head);
    Display(head);
